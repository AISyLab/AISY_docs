...
def run(x_profiling, y_profiling, plaintexts_profiling,
    ...
    for key_rank_execution in range(1, key_rank_executions + 1):
        ...
        print("KR run: {} | final GE for correct key ({}): {})".format(key_rank_execution, good_key, final_kr / key_rank_execution + 1))
