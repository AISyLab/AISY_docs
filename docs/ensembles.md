...
sca_aisy = Aisy()
sca_aisy.set_dataset("ascad-variable.h5")
sca_aisy.set_database_name("database_ascad.sqlite")
sca_aisy.set_aes_leakage_model(leakage_model="HW", byte=2)
sca_aisy.set_number_of_profiling_traces(10000)
sca_aisy.set_number_of_attack_traces(1000)
sca_aisy.set_batch_size(400)
sca_aisy.set_epochs(50)
